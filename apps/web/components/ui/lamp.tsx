...
export function LampDemo() {
  return (
    <LampContainer>
      <h1 className="relative z-20 bg-gradient-to-b from-neutral-100 to-neutral-500 bg-clip-text text-center font-cal text-4xl font-bold text-transparent sm:text-7xl">
        Emails <br /> Elevated to Extraordinary
      </h1>
      <div className="max-w-3xl text-center">
        <p className="mt-6 text-lg leading-8 text-foreground/60">
          Caley.io reimagines your inbox with a fusion of AI brilliance and
          unmatched efficiency. Think smarter analytics, streamlined
          conversations, and effortless newsletter management all in one sleek
          package. More than an email client, <br /> it&apos;s your unfair
          advantage.
        </p>
      </div>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex min-h-[42rem] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-black",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/4 rounded-full bg-cyan-500 opacity-40 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
      ...
      <div className="relative z-50 flex -translate-y-[9rem] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
