...
const InputWithLeftFixedText = (props: {
  ...
  return (
    ...
    >
      <span className="inline-flex max-w-[150px] flex-shrink items-center rounded-l-md border border-r-0 border-foreground bg-background px-3 text-foreground sm:max-w-full sm:text-sm">
        {props.leftText}
      </span>
      <input
        {...props.inputProps}
        className="block w-[120px] flex-1 rounded-none rounded-r-md border-foreground bg-background focus:border-black focus:ring-black sm:w-full sm:min-w-[150px] sm:max-w-full sm:text-sm"
      />
    </div>
  );
};
...
const InputWithRightFixedText = (props: {
  ...
  return (
    ...
    >
      <input
        {...props.inputProps}
        className="block w-full min-w-0 flex-1 rounded-none rounded-l-md border-foreground focus:border-black focus:ring-black sm:text-sm"
      />
      <span className="inline-flex items-center rounded-r-md border border-l-0 border-foreground bg-background px-3 text-foreground sm:text-sm">
        {props.rightText}
      </span>
    </div>
  );
